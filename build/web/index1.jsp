...
<% 
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div id="parent" style="display: none">
                    ...
                    <% int forn = ((intlevel == 1) ? 10 : intlevel == 2 ? 20 :  20);
                    out.println(forn);
                    ...
                    %>
                    <div class="message <% if(i > 4)  { out.print("lazyload"); } else out.print(""); %>" onclick="clicked(<%=i%>,<%=n%>)" id="message_<%= i%>"
                          style='<% if(i > 4)  { out.print("display:none"); } else out.print(""); %>' >
    ...
    function lazyload(){
        console.log("called");
    //after 2 sec delay enable one message div with class alter
    setInterval(function () {
        var lazyloaddiv = $(".lazyload")[0];
        console.log("div"+message+$(lazyloaddiv).show()+$(lazyloaddiv).removeClass("lazyload"));
